...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="DropDownList3" runat="server" Height="22px" Width="110px" >
        ...
        <tr>
            ...
            <td class="auto-style12">
                <asp:TextBox ID="txtPassword" runat="server"  maxlength="320" CssClass="auto-style16"  /></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style9">
            ...
            <td class="auto-style12">
                <asp:TextBox ID="txtConfirm" runat="server"  maxlength="320" CssClass="auto-style16"  /></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style9">
