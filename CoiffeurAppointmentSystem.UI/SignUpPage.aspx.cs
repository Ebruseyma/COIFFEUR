...
namespace CoiffeurAppointmentSystem
{
    public partial class SignUpPage : System.Web.UI.Page
    {
        ...
        string connectionString = @"Data Source=DESKTOP-TDJVJ54\SQLEXPRESS; Initial Catalog = CoiffeurAppointmentSystem; Integrated Security=True;";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sqlcon.Open();
                    SqlCommand cmd = new SqlCommand("insert into cas.person " + "(first_name,last_name,gender_id,email,password,city_id,birth_day)values(@first_name, @last_name, @gender_id, @email, @password, @city_id, @birth_day)", sqlcon);
